...
function(input, output, session) {
  ...
  # observeEvent(input$neighborhood, {
    ...
    session$onFlushed(once=T, function(){
      ...
      observeEvent(input$compare_1, {
        observeEvent(input$compare_2, {
        ...
        observe({
          output$map1 = renderLeaflet({
            leaflet(options = leafletOptions(zoomControl = FALSE)) %>%
              addTiles() %>%
              addMarkers(data = df_property1(), lng = ~Longitude,
                         lat = ~Latitude)
          })
        })
      })
...
#############################################
      ...
      output$valuebox2 <- renderValueBox({
        ...
        if (rv$tabSelected == 'Search') {
          ...
          label = HTML(paste0(
            '<i>Closest Park</i> : <b>', '', '0.4mi away</b><br>',
            '<i>Closest Subway</i> : <b>', '', '0.3mi away</b><br>',
            '<i>Nearby Restaurants</i> : <b>', '', '37</b><br>',
            '<i>Nearby Coffee Shops</i> : <b>', '', '17</b><br>'
            ))
          info = HTML(paste0('Point of Interests', ''))
      ...
      output$nb_info <- renderInfoBox({
        ...
        info = case_when(
          df_property()$Neighborhood == 'All Neighborhoods' ~ 'Ames is a city located in the state of Iowa in the United States, home to Iowa State University and a vibrant scientific community.',
          df_property()$Neighborhood == 'IDOTRR' ~ ' is an affordable neighborhood with historic homes and easy access to downtown amenities, parks, and shopping areas.', 
          df_property()$Neighborhood == 'NAmes' ~ ' is an affordable neighborhood with a mix of mid-century and modern homes, mature trees, parks, and easy access to amenities.', 
          df_property()$Neighborhood == 'Gilbert' ~ " is a budget-friendly neighborhood known for its rural charm, community events, and convenient location to the city's amenities.", 
          df_property()$Neighborhood == 'StoneBr' ~ ' is a mid-range neighborhood with newer homes, community pools and parks, and access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'NWAmes' ~ ' is a family-friendly neighborhood known for its affordable homes, parks, and proximity to a variety of shopping / dining areas.', 
          df_property()$Neighborhood == 'Somerst' ~ ' is an upscale neighborhood with modern and traditional homes, walking trails, parks, and easy access to shopping and dining.', 
          df_property()$Neighborhood == 'BrDale' ~ ' is an affordable neighborhood with mid-century homes, mature trees, and access to amenities such as parks, shopping, and dining.', 
          df_property()$Neighborhood == 'NPkVill' ~ ' is a budget-friendly neighborhood known for its diverse housing options, green spaces, and proximity to shopping and dining.', 
          df_property()$Neighborhood == 'NridgHt' ~ ' is an upscale neighborhood with newer homes, walking trails, community pools and parks, and easy access to amenities and shopping.', 
          df_property()$Neighborhood == 'Blmngtn' ~ ' is a mid-range neighborhood with a mix of housing options, parks, and easy access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'NoRidge' ~ ' is an upscale neighborhood with modern and traditional homes, walking trails, parks, and easy access to shopping and dining.', 
          df_property()$Neighborhood == 'SawyerW' ~ ' is an affordable neighborhood with a mix of mid-century and modern homes, parks, and easy access to many city amenities.', 
          df_property()$Neighborhood == 'Sawyer' ~ ' is an affordable neighborhood  known for its diverse housing options, green spaces, and convenient location to many city amenities.', 
          df_property()$Neighborhood == 'Veenker' ~ ' is an upscale neighborhood with large, traditional homes, mature trees, and easy access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'Greens' ~ ' is a mid-range neighborhood with a mix of housing options, parks, and easy access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'BrkSide' ~ ' is a budget-friendly neighborhood known for its small, mid-century homes, parks, and convenient location to many amenities.', 
          df_property()$Neighborhood == 'OldTown' ~ ' is an affordable neighborhood with a mix of historic and modern homes, a vibrant downtown area, and easy access to parks and trails.', 
          df_property()$Neighborhood == 'ClearCr' ~ ' is a budget-friendly neighborhood known for its small, mid-century homes, parks, and easy access to amenities and shopping areas.', 
          df_property()$Neighborhood == 'Edwards' ~ ' is an affordable neighborhood with a mix of mid-century and modern homes, parks, and easy access for shopping and dining.', 
          df_property()$Neighborhood == 'SWISU' ~ ' is a budget-friendly neighborhood known for its diverse housing options, parks, and convenient location to many shopping areas.', 
          df_property()$Neighborhood == 'CollgCr' ~ ' is a mid-range neighborhood with newer homes, community pools and parks, and easy access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'Crawfor' ~ ' is an affordable neighborhood with a mix of small, mid-century homes, parks, and easy access to amenities such as shopping and dining.', 
          df_property()$Neighborhood == 'Mitchel' ~ ' is a budget-friendly neighborhood known for its diverse housing options, parks, and convenient location to shopping areas.', 
          df_property()$Neighborhood == 'Timber' ~ ' is a mid-range neighborhood with a mix of housing options, community pools and parks, and easy access for shopping and dining.', 
          df_property()$Neighborhood == 'MeadowV' ~ ' is an affordable neighborhood with small, mid-century homes, parks, and convenient location to amenities and shopping areas'
        )
