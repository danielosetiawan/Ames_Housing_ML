...
df_predictions %>%
  filter(distance != 0,
         ...
         between(GrLivArea, -0.9*property$GrLivArea, 1.1*property$GrLivArea),
         between(LotArea, -0.9*property$LotArea, 1.1*property$LotArea),
         between(OverallQual, -0.9*property$OverallQual, 1.1*property$OverallQual),
         between(OverallCond, -0.9*property$OverallCond, 1.1*property$OverallCond),
